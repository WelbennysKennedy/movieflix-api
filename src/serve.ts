...
app.put('/movies/:id', async (req, res) => {
    ...
    try {
        ...
        if (genre_id !== undefined) data.genre_id = parseIntegerField(genre_id, 'genre_id')
        if (language_id !== undefined) data.language_id = parseIntegerField(language_id, 'language_id')
        if (oscar_count !== undefined) data.oscar_count = parseIntegerField(oscar_count, 'oscar_count')
        if (release_date !== undefined) data.release_date = parseDateField(release_date, 'release_date')
